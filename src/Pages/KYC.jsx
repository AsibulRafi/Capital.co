        ...
        <div className="flex">
          <div className="flex__section">
            <p>
              ...
              laundering, financial fraud and terrorist activity. No name 1
          ...
          <div className="flex__section">
            <p>
              Prevention: No name 1 aims to ensure the integrity of any
        ...
        <div className="flex">
          <div className="flex__section">
            ...
            <p>
              ...
              make No name 1 a safer place to trade.
            </p>
          </div>
          <div className="flex__section">
