...
const Privacy = () => {
  return (
    <section className="terms">
      <h2 className="terms__heading">Privacy Policy</h2>
      ...
      <p style={{ textAlign: "center" }}>
        We advise you to familiarize yourself with our privacy protocol and let
        us know in case you have any inquiries. The arrangements stated in this
        protocol are applicable to current and previous users as well.
      </p>
      <div className="flex">
        <div className="flex__section">
          <h2>1. Private information.</h2>
          <p>
            At the time activating of your profile at No name 1, we would
            ...
            the necessary transfers and trades, to determine your financial
            scope, to handle any forgotten password issues, make customer care
            easier and let you know about any Forex related matter that might
            concert you. We are also obliged by the law to keep proper records.
          </p>
          <h2>
          ...
          <p>
            ...
            social security, proper address. We might also need to make sure of
            your occupation, financial status, and more relevant information, as
            described during the process of creating a profile.
          </p>
          <p>
            In order to make transfer funds – statements or copies of previous
            correspondence and details about your transfers with No name 1 or
            its partners, along with any trading actions, financial statements,
          ...
          <p>
            ...
            statements, bank card information and so on.
          </p>
          <p>
            Attention: No name 1 is obliged by the AML and the USA Patriot Act
            to gather any data if there is a need and act accordingly to verify
        ...
        <div className="flex__section">
          ...
          <p>
            ...
            the user`s browser and kept on the user`s device. This is referred
            to as cookies. No name 1 gathers necessary data by using the
            ...
            provided such information by himself – like when opening a profile
            at a website. No name 1 will utilize the cookies for the purpose of
            identifying and quantifying platform traffic, along with measuring
            how certain services and ads are performing.
          </p>
          <p>
            ...
            materials and information we should provide to you.
          </p>
          <p>
            The collected data might also be made available to No name 1 staff,
            partners, and associates. No name 1 will not use the information for
            commercial purposes by providing it to any unassociated individuals
            or entities.
          </p>
          <p>
            ...
            would advise you to take a look at the terms and conditions of those
            affiliate parties` websites in case you have any questions or issues
            regarding their placement of cookies. Usually, the usage of cookies
            is the same as on No name 1.
          </p>
          ...
          <p>
            ...
            The confidentiality of your private data will be kept by our
            partners as it is being kept by No name 1, following the privacy
            terms and conditions stated on the platform.
          </p>
        </div>
      </div>
      ...
      <div className="flex">
        <div className="flex__section">
          ...
          <p>
            ...
            same degree in which it is received. The non-associate party can
            only utilize the given user data in order to provide the specified
            service and for no other reasons.
          </p>
          <p>
            In some cases, No name 1 might give out a clients` private data to
            another party given that there are certain instructions that need to
            be accomplished. Know that No name 1 would never use your
            information as a source of revenue and give it in exchange for
            money.
          </p>
          <p>
            In case of any requests and control by bodies of the law, No name 1
            might share private user data given to other parties. The shared
          ...
          <p>
            ...
            in case there is a merger of No name 1. Stated in the inclusion
          ...
          <p>
            In case you`re asked to give a copy of your bank card, you should
            only provide the ending 4 digits of the card number, without giving
            out the CVC which can be found on the back of the card.
          </p>
        </div>
        <div className="flex__section">
          ...
          <p>
            ...
            detailed message. Know that any omitted data might result in issues
            with your profile and consequently lead to inadequacy with the
            platform services.
          </p>
